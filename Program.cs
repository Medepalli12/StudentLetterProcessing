...
namespace StudentLetterProcessing
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                //logging errors
                File.WriteAllText(ConfigurationManager.AppSettings["outputFilePath"].ToString() + "Logs.txt", DateTime.Now + " Error" + Environment.NewLine + "---------------------" + Environment.NewLine + Environment.NewLine + ex.Message.ToString()+ Environment.NewLine + ex.StackTrace.ToString());
